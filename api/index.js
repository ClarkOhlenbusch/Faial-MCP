...
server.registerTool("faial.get_version", {
...
server.registerTool("faial.analyze_file", {
...
server.registerTool("faial.analyze_directory", {
...
server.registerTool("faial.analyze_text", {
...
function normalizeFaialResult(res, label) {
