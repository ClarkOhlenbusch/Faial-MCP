 ...
 */
export async function resolveFaialExecutable(env = process.env) {
...
export async function runFaial(args, options = {}) {
...
export async function getFaialVersion() {
