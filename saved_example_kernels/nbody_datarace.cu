                 ...
                 int numBodies)
{
         ...
         tile < numTiles + blockIdx.y; tile++)
    {
        ...
        // __syncthreads(); // DATA RACE: Missing syncthreads allows threads to read position data from shared memory before all threads finish loading it
